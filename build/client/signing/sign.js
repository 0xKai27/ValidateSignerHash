...
function signMessage() {
    return __awaiter(this, void 0, void 0, function* () {
        // Encode the payload
        let payload = ethers_1.ethers.utils.defaultAbiCoder.encode(["string"], [unsignedMessage]);
        console.log(`Payload:`);
        ...
        signedMessage = yield signer_1.signer.signMessage(ethers_1.ethers.utils.arrayify(payloadHash));
